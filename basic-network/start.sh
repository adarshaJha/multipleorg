...
docker-compose -f docker-compose.yml up -d ca.org1.example.com ca.org2.example.com orderer.example.com peer0.org1.example.com couchdb0 peer1.org1.example.com couchdb1 peer0.org2.example.com couchdb2 peer1.org2.example.com couchdb3
...
# Fetch
# docker exec -e "CORE_PEER_LOCALMSPID=Org2MSP" -e "CORE_PEER_MSPCONFIGPATH=/etc/hyperledger/msp/users/Admin@org2.example.com/msp" peer0.org2.example.com peer channel fetch 0 -o orderer.example.com:7050 -c ppchannel 
# Join peer0.org2.example.com to the channel.
# docker exec -e "CORE_PEER_LOCALMSPID=Org2MSP" -e "CORE_PEER_MSPCONFIGPATH=/etc/hyperledger/msp/users/Admin@org2.example.com/msp" peer0.org2.example.com peer channel join -b ppchannel.block
